//
//  AppDelegate.swift
//  GradiusThreeStarsRunner
//
//  Created by ran on 5/10/20.
...
class AppDelegate: NSObject {
  ...
  {
//    let saverName = UserDefaults.standard.string(forKey: "saver") ?? "StageTwoBaseOne"
    let saverName = "GradiusThreeStars"
